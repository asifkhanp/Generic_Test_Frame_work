...
class HtmlReport():
    def generate_report(self,f):
        ...
        html_file = os.path.join(os.getcwd(), './Testcase/html_report.html')
    ...
    def run(self):
            file_name = os.path.join(os.getcwd(), './Testcase/json_report')#input('Enter The File Name With Extension: ')
            print('***********************************************************************')
